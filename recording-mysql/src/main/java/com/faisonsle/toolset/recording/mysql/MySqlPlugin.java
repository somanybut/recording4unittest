    ...
    private void addConnectionTransformer(final MySqlConfig config) {
        TransformCallback transformer = new TransformCallback() {
            ...
            public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) throws InstrumentException {
                ...
                if (constructor != null) {
                    constructor.addInterceptor("MySQLConnectionCreateInterceptor");
                }
                // 6.0.2 ~ 6.0.3
                ...
                if (constructor_6_X != null) {
                    target.addGetter("OrigHostToConnectToGetter", "origHostToConnectTo");
                    target.addGetter("OrigPortToConnectToGetter", "origPortToConnectTo");
                    target.addGetter("DatabaseGetter", "database");
                    constructor_6_X.addInterceptor("MySQL_6_X_ConnectionCreateInterceptor");
                }
